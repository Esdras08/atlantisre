...
@Component({
    selector: 'app-autocomplete-fonctionnalite',
    template: `
...
export class FonctionnaliteAutocompleteComponent extends SgiAutocomplete {
    ...
    beforeAll(): void {
        ...
        this.setSearchParams([
            new ModelMaskFieldImpl<any>().setTitle('Libellé').setName('Libelle'),
        ]);
