...
import {UtilisateurComboComponent} from './utilisateur.combo.component';
import {UtilisateurAutocompleteComponent} from './utilisateur.autocomplete.component';
...
@NgModule({
    ...
    declarations: [UtilisateurComboComponent, UtilisateurAutocompleteComponent],
    exports: [UtilisateurComboComponent, UtilisateurAutocompleteComponent],
    providers: [
