...
@Component({
    selector: 'app-autocomplete-utilisateur',
    template: `
...
export class UtilisateurAutocompleteComponent extends SgiAutocomplete {
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.getTableParams()
            .addColumn(new ClvTableColumnField().setTitle('Nom'))
            .addColumn(new ClvTableColumnField().setTitle('Prénoms'))
    ...
    beforeAll(): void {
        ...
        this.setSearchParams([
            new ModelMaskFieldImpl<any>().setTitle('Nom').setName('Nom'),
            new ModelMaskFieldImpl<any>().setTitle('Prénom').setName('Prenom'),
        ]);
