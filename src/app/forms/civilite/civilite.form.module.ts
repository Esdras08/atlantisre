...
import {CiviliteComboComponent} from './civilite.combo.component';
...
@NgModule({
    ...
    declarations: [CiviliteComboComponent],
    exports: [CiviliteComboComponent],
    providers: [
        {provide: HTTP_INTERCEPTORS, useClass: ServerURLInterceptor, multi: true}
    ]
})
export class CiviliteFormModule {
}
