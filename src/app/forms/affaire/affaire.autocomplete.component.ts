...
@Component({
    selector: 'app-autocomplete-affaire',
    template: `
      ...
      <mat-autocomplete #auto="matAutocomplete">
          ...
          <clv-advanced-table class="table-autocomplete" [params]="getTableParams()">
              <clv-tr [params]="getTableParams()"
                      (click)="handleInputChange(item[getDisplayedField()]); minp.value = mopt.value = item[getDisplayedField()];
                       mopt._getHostElement().click();" ngClass="crsr-pointer"
                  ...
                  <clv-td><div fxLayout="row" fxLayoutAlign="space-between">
                      <div>{{item['NumeroPolice']}}</div>
                  </div></clv-td>
                  <clv-td><div fxLayout="row" fxLayoutAlign="space-between">
                      <div>{{item['CapitauxAssure']}}</div>
                  </div></clv-td>
              </clv-tr>
          </clv-advanced-table>
      </mat-autocomplete>
...
export class AffaireAutocompleteComponent extends SgiAutocomplete {
