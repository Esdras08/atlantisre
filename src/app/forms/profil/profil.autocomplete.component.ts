...
@Component({
    selector: 'app-autocomplete-profil',
    template: `
...
export class ProfilAutocompleteComponent extends SgiAutocomplete {
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.getTableParams()
            .addColumn(new ClvTableColumnField().setTitle('Intitulé'))
    ...
    beforeAll(): void {
        ...
        this.setSearchParams([
            new ModelMaskFieldImpl<any>().setTitle('Intitulé').setName('Intitule'),
        ]);
