...
import {PieceIdentiteComboComponent} from './pieceIdentite.combo.component';
...
@NgModule({
    ...
    declarations: [PieceIdentiteComboComponent],
    exports: [PieceIdentiteComboComponent],
    providers: [
        {provide: HTTP_INTERCEPTORS, useClass: ServerURLInterceptor, multi: true}
    ]
})
export class PieceIdentiteFormModule {
}
