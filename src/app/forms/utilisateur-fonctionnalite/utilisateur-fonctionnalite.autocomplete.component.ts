...
@Component({
    selector: 'app-autocomplete-utilisateur-fonctionnalite',
    template: `
...
export class UtilisateurFonctionnaliteAutocompleteComponent extends SgiAutocomplete {
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.getTableParams()
            .addColumn(new ClvTableColumnField().setTitle('Codce'))
    ...
    beforeAll(): void {
        ...
        this.setSearchParams([
            new ModelMaskFieldImpl<any>().setTitle('Code').setName('CodeFonctionnalite'),
        ]);
