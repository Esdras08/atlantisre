...
@Component({
    selector: 'app-autocomplete-reassureur',
    template: `
...
export class ReassureurAutocompleteComponent extends SgiAutocomplete {
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.getTableParams()
            .addColumn(new ClvTableColumnField().setTitle('Nom Réassureur'))
    ...
    beforeAll(): void {
        ...
        this.setSearchParams([
            new ModelMaskFieldImpl<any>().setTitle('Nom Réassureur').setName('NomReassureur'),
        ]);
        this.setDisplayedField('NomReassureur');
