...
@Component({
    selector: 'app-autocomplete-profil-fonctionnalite',
    template: `
...
export class ProfilFonctionnaliteAutocompleteComponent extends SgiAutocomplete {
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.getTableParams()
            .addColumn(new ClvTableColumnField().setTitle('Code'))
