...
import {FormeJuridiqueComboComponent} from './formeJuridique.combo.component';
...
@NgModule({
    ...
    declarations: [FormeJuridiqueComboComponent],
    exports: [FormeJuridiqueComboComponent],
    providers: [
        {provide: HTTP_INTERCEPTORS, useClass: ServerURLInterceptor, multi: true}
    ]
})
export class FormeJuridiqueFormModule {
}
