...
@Component({
    selector: 'app-autocomplete-processus',
    template: `
...
export class ProcessusAutocompleteComponent extends SgiAutocomplete {
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.getTableParams()
            .addColumn(new ClvTableColumnField().setTitle('Catégorie'))
    ...
    beforeAll(): void {
        ...
        this.setSearchParams([
            new ModelMaskFieldImpl<any>().setTitle('Catégorie').setName('Categorie'),
        ]);
        this.setDisplayedField('Categorie');
