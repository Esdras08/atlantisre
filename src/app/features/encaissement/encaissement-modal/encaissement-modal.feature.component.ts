...
@Component({
    ...
    templateUrl: './encaissement-modal.feature.component.html',
    providers: []
})
export class EncaissementModalFeatureComponent extends SgiModalForm implements OnInit {
    constructor(public httpRequest: HttpClient,
                ...
                public dialogRef: MatDialogRef<EncaissementModalFeatureComponent>,
