...
@Component({
    selector: 'app-re-affaire',
    templateUrl: './affaire.feature.component.html',
})
export class AffaireFeatureComponent extends SgiTableModal implements OnChanges {
    ...
    constructor(public httpClient: HttpClient,
        ...
        // .addColumn(new ClvTableColumnField().setTitle(''))
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('AFFAIRE.TABLE.COLUMNS.NUMERO_ORDRE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('AFFAIRE.TABLE.COLUMNS.NUMERO_POLICE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('AFFAIRE.TABLE.COLUMNS.CAPITAUX_ASSURE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('AFFAIRE.TABLE.COLUMNS.ACTIVITE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('AFFAIRE.TABLE.COLUMNS.STATUT_AFFAIRE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('AFFAIRE.TABLE.COLUMNS.BRANCHE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('AFFAIRE.TABLE.COLUMNS.FILIALE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('AFFAIRE.TABLE.COLUMNS.ASSURE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('AFFAIRE.TABLE.COLUMNS.ACTIONS'))
