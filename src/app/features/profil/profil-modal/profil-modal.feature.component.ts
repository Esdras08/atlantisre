...
// @dynamic
@Component({
    selector: 'app-pays-profil',
    templateUrl: './profil-modal.feature.component.html',
    providers: []
})
export class ProfilModalFeatureComponent extends SgiModalForm implements  OnInit {
    constructor(public httpRequest: HttpClient,
                ...
                public dialogRef: MatDialogRef<ProfilModalFeatureComponent>,
