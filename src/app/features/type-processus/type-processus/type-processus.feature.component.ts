...
@Component({
    selector: 'app-re-type-processus',
    templateUrl: './type-processus.feature.component.html',
})
export class TypeProcessusFeatureComponent extends SgiTableShowModal implements OnChanges {
    ...
    constructor(public httpClient: HttpClient,
        ...
        this.setContent(TypeProcessusModalFeatureComponent);


        this.getTableParams()
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('TYPE_PROCESSUS.TABLE.COLUMNS.LIBELLE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('TYPE_PROCESSUS.TABLE.COLUMNS.ACTIONS'))
