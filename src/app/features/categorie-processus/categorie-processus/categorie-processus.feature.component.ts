...
@Component({
    selector: 'app-re-categorie-processus',
    templateUrl: './categorie-processus.feature.component.html',
})
export class CategorieProcessusFeatureComponent extends SgiTableShowModal implements OnChanges {
    ...
    constructor(public httpClient: HttpClient,
        ...
        this.setContent(CategorieProcessusModalFeatureComponent);


        this.getTableParams()
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('CATEGORIE_PROCESSUS.TABLE.COLUMNS.LIBELLE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.translate.instant('CATEGORIE_PROCESSUS.TABLE.COLUMNS.ACTIONS'))
