...
// @dynamic
@Component({
    selector: 'app-re-statut-affaire-modal',
    templateUrl: './statut-affaire-modal.feature.component.html',
    providers: []
})
export class StatutAffaireModalFeatureComponent extends SgiModalForm implements OnInit {
    constructor(public httpRequest: HttpClient,
                ...
                public dialogRef: MatDialogRef<StatutAffaireModalFeatureComponent>,
