...
@Component({
    ...
    templateUrl: './personne-morale-modal.feature.component.html',
    providers: [ {provide: MAT_DATE_LOCALE, useValue: 'fr-FR'},
        {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
        {provide: MAT_DATE_FORMATS, useValue: MAT_MOMENT_DATE_FORMATS}]
})
export class PersonneMoraleModalFeatureComponent extends SgiModalForm implements  OnInit, AfterViewInit {
    ...
    constructor(public httpRequest: HttpClient,
                ...
                public dialogRef: MatDialogRef<PersonneMoraleModalFeatureComponent>,
