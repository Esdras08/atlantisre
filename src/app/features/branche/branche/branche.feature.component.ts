...
@Component({
    selector: 'app-re-branche',
    templateUrl: './branche.feature.component.html',
})
export class BrancheFeatureComponent extends SgiTableShowModal implements OnChanges {
    ...
    constructor(public httpClient: HttpClient,
        ...
        this.setContent(BrancheModalFeatureComponent);

        this.getTableParams()
        // .addColumn(new ClvTableColumnField().setTitle(''))
            .addColumn(new ClvTableColumnField().setTitle(translateService.instant('BRANCHE.TABLE.COLUMNS.LIBELLE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.instant('BRANCHE.TABLE.COLUMNS.CODE')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.instant('BRANCHE.TABLE.COLUMNS.DESCRIPTION')))
            .addColumn(new ClvTableColumnField().setTitle(translateService.instant('BRANCHE.TABLE.COLUMNS.ACTIONS'))
