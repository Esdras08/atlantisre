...
@Component({
    ...
    templateUrl: './branche-modal.feature.component.html',
    providers: []
})
export class BrancheModalFeatureComponent extends SgiModalForm implements  OnInit {
    constructor(public httpRequest: HttpClient,
                ...
                public dialogRef: MatDialogRef<BrancheModalFeatureComponent>,
